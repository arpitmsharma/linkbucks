...
<body>
						...
						<div class="panel-body">
							<div class="top-stats-panel">
								<div class="gauge-canvas">
									<h4 class="widget-h">Other's Link Verified By You</h4>
									<canvas width=160 height=100 id="gaugeOtherLink"></canvas>
								</div>
	...
	<script type="text/javascript">
		var target = document.getElementById('gaugeOtherLink'); // your canvas element
